...
{
    public interface IItemDataModel : IModel
    {
        public ItemConfig GetItemConfig(ItemTypeEnum itemType);
    }

    public class ItemDataModel : AbstractModel, IItemDataModel
    {
        private Dictionary<ItemTypeEnum, ItemConfig> _itemConfigs = new Dictionary<ItemTypeEnum, ItemConfig>()
        {
            ...
            {ItemTypeEnum.Supply_Health, new ItemConfig(ItemTypeEnum.Supply_Health, true, 3)},
            {ItemTypeEnum.Supply_Ammo, new ItemConfig(ItemTypeEnum.Supply_Ammo, true, 3)},
    ...
    public class ItemConfig
    {
        ...
        public ItemConfig(ItemTypeEnum itemType, bool canStack, int maxStack)
        {

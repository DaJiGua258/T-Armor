...
{
    /// <summary>
    /// 空中敌人死亡状态：先下落，落地时播放死亡特效。
    /// </summary>
    public class AirEnemyDeathState : AbstractState<AbstractEnemy>
    {
        public AirEnemyDeathState(AbstractEnemy owner, StateMachine<AbstractEnemy> fsm)
            : base(owner, fsm) { }

...
public class CameraController : MonoBehaviour
{
    ...
    [Header("光标偏移")]
    [SerializeField] private float _mouseThreshold = 3f;       // 光标距玩家超过此距离时开始偏移
    ...
    void LateUpdate()
    {
        ...
        if (mouseDist > _mouseThreshold)
        {
            float offsetMag = Mathf.Min(mouseDist - _mouseThreshold, _mouseMaxOffset);
